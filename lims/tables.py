...
class AccessionTable(tables.Table):
    ...
    genus = tables.Column(accessor='genus', verbose_name='Genus')
    subgenus = tables.Column(accessor='subgenus', verbose_name='Subgenus')
    genome = tables.Column(accessor='genome', verbose_name='Genome')
